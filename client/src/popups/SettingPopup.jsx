      ...
      <div className='w-full bg-white rounded-lg shadow-lg sm:w-auto lg:w-1/2 2xl:w-1/3'>
        <div className='p-8'>
          <header className='flex justify-between items-center mb-7 pb-5 border-b-[1px] border-black'>
            ...
            <img src={closeSquare} alt="" onClick={() => dispatch(toggleSettingPopup())} className='cursor-pointer' />
          </header>

          <form onSubmit={handleUpdatePassword}>

            <div className='mb-4 sm:flex gap-4 items-center'>
              <label htmlFor="block text-gray-900 font-medium w-full">Enter Current Password</label>
            ...
            <div className='mb-4 sm:flex gap-4 items-center'>
              <label htmlFor="block text-gray-900 font-medium w-full">Enter New Password</label>
            ...
            <div className='mb-4 sm:flex gap-4 items-center'>
              <label htmlFor="block text-gray-900 font-medium w-full">Confirm New Password</label>
