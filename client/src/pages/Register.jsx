    ...
    <div className='flex flex-col justify-center md:flex-row h-screen'>
       ...
       <div className='hidden w-full md:w-1/2 bg-black text-white md:flex flex-col items-center justify-center p-8 rounded-tr-[80px] rounded-br-[80px]'>
        <div className='text-center h-[376px]'>
          ...
          <Link to={"/login"} className='border-2 rounded-lg font-semibold py-2 px-8 border-white hover:bg-white hover:text-black transition'>
          SIGN IN
          </Link>
        </div>
       </div>
       ...
       <div className='w-full max-w-sm'>
        <div className='flex justify-center mb-12'>
          <div className='flex flex-col-reverse sm:flex-row items-center justify-center gap-5 '>
            ...
            <img src={blackLogo} alt="" className='h-auto w-24 object-cover'/>
          </div>
        </div>
